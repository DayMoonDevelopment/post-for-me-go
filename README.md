...
```sh
go get -u 'github.com/DayMoonDevelopment/post-for-me-go@v0.1.0-alpha.13'
```
...
The postforme library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
`*postforme.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `postforme.File(reader io.Reader, filename string, contentType string)`
